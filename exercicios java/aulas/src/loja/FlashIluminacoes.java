...
public class FlashIluminacoes {
	...
	public static void main(String[] args) {
		...
		produtos.add(new Produto("FLA-004", "ABAJUR ALUMÍNIO", 90, 10));
		...
		produtos.add(new Produto("FLA-008", "LUSTRE PRETO 3 LÂMPADAS", 350, 10));
		produtos.add(new Produto("FLA-009", "LUSTRE ROSÊ 13 LÂMPADAS", 1400, 10));
